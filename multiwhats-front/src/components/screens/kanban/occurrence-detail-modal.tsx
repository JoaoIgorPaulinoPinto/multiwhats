...
import { kanbanService, type OccurrenceResponse, type OccurrenceStatus } from "../../../services/kanban.service"
import { OCCURRENCE_STATUS_OPTIONS, PRIORITY_LABELS, PRIORITY_COLORS } from "../../../constants"
...
export function OccurrenceDetailModal({ occurrence, onClose, onStatusChange, onDelete }: DetailModalProps) {
  ...
  const statusInfo = OCCURRENCE_STATUS_OPTIONS.find((s) => s.value === occurrence.status)
  ...
  return (
    <Modal title={editing ? "Editar Ocorrência" : "Detalhes da Ocorrência"} onClose={onClose} error={error}>
